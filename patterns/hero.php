...
return [
	...
	'description' => __( 'Full-bleed photo hero with H1, trust badges, and a primary CTA. First block on every page.', 'skyline-cruises' ),
	'categories'  => [ 'skyline-sections' ],
	'content'     => '<!-- wp:group {"className":"hero","style":{"background":{"backgroundImage":{"url":"' . esc_url( get_template_directory_uri() . '/assets/images/hero-placeholder.jpg' ) . '"}}}} -->
